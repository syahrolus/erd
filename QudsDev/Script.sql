...
VALUES (DEFAULT, "stepen", "stepen@gmail.com", "spanyol", "2000-12-15", 1);
INSERT INTO Admin (id_admin, nama_admin, email, alamat, tgl_lahir, gender) 
VALUES (DEFAULT, "carloz", "carloz@gmail.com", "argentina", "2000-12-30", 2);
SELECT * FROM Admin;
# data kategori event
...
#VALUES 
#	(DEFAULT, "instruktur 1", "1995-01-01", "jerman", 1, ),
#	();
